...
import { FaEdit, FaEye, FaPen, FaPlus, FaTrash } from 'react-icons/fa';
    ...
    <DashboardLayout>
      <Breadcrumb>
        <li className="inline-flex items-center">
          ...
          <span className="h-auto text-gray-400 font-medium">Club List</span>
        </li>
      </Breadcrumb>
      ...
      <DataTable
        ...
        responsive
        actions={
          <Link to='/admin/club/create' className="inline-flex items-center p-1 bg-green-600 hover:bg-red-700 text-white text-sm font-medium rounded">
            <FaPlus />
            Add New Clubs
          </Link>
        }
